...
if ( current_user_can('install_themes') ) {
	...
	<br /><br />
	If your blog displays two different templates (Joomla's and Wordpress's), it will have duplicate html, head, title and other important tags that should only display once per page. The Twenty Ten theme comes modified to work inside of Joomla, but any other theme won't be like this.
	<?php
}
?>
