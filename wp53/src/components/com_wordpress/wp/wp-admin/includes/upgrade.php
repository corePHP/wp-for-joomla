...
if ( ! function_exists( 'wp_install' ) ) :
	...
	function wp_install( $blog_title, $user_name, $user_email, $public, $deprecated = '', $user_password = '', $language = '' ) {
		...
		/* rc_corephp - Create WP user based on Joomlas user end */
		...
		wp_new_blog_notification( $blog_title, $guessurl_mail, $user_id, ( $email_password ? $user_password : __( 'The password you chose during installation.' ) ) );
		/* rc_corephp end */
