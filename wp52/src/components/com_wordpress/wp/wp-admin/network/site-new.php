...
<?php wp_nonce_field( 'add-blog', '_wpnonce_add-blog' ); ?>
	<table class="form-table">
		...
		<tr class="form-field">
			<td colspan="2"><p id="site-admin-email">Select the user to be the administrator of this blog. New users must be created through Joomla first.<?php // rc_corephp - We don't need this _e( 'A new user will be created if the above email address is not in the database.' ) ?><br /><?php _e( 'The username and password will be mailed to this email address.' ) ?></p></td>
		</tr>
	</table>
