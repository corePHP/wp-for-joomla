...
?>
<form name="loginform" id="loginform" action="<?php echo esc_url( network_site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post">
<?php /* rc_corephp - end FIX for login issue with mulisite */ ?>
	<p>
		<label for="user_login"><?php _e( 'Username or Email Address' ); ?><br />
