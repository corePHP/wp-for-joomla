...
function login_footer($input_id = '') {
	?>
	<p id="backtoblog"><a href="<?php echo esc_url( untrailingslashit( home_url( '/' ) ) ); ?>" title="<?php esc_attr_e( 'Are you lost?' ); ?>"><?php printf( __( '&larr; Back to %s' ), get_bloginfo( 'title', 'display' ) ); ?></a></p>
	</div>
