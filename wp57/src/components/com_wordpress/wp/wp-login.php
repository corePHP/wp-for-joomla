...
switch ( $action ) {
	...
	default:
		...
		wp_enqueue_script( 'user-profile' );
		/* rc_corephp - FIX for login issue with mulitsite */
		?>

<form name="loginform" id="loginform" action="<?php echo esc_url( network_site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post"><?php /* rc_corephp - end FIX for login issue with mulisite */ ?>
			<p>
				<label for="user_login"><?php _e( 'Username or Email Address' ); ?></label>
